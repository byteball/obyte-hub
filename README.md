...
You need a private key generated by Byteball Team for you, key_id and team_id to communicate with APNS servers on behalf of Byteball app bundle, email us for ones: byteball@byteball.org, then configure your hub (conf.js or conf.json) to enable notifications.
